...
class Tester():
    ...
    def test_model(self):
        ...
        # Calculate the number of steps needed to predict every window of the test set.
        steps_per_test_epoch = int(np.ceil((test_generator.total_size - 2 * self.__window_offset) / self.__batch_size))
