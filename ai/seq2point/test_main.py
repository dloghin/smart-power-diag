...
parser.add_argument("--saved_models_dir", type=str, default="saved_models/", help="The directory containing the trained model; the test log is written there too. Default is saved_models/. ")

arguments = parser.parse_args()

# You need to provide the trained model
saved_model_dir = os.path.join(arguments.saved_models_dir, arguments.appliance_name + "_" + arguments.algorithm + "_model.h5")

# The logs including results will be recorded to this log file
log_file_dir = os.path.join(arguments.saved_models_dir, arguments.appliance_name + "_" + arguments.algorithm + "_" + arguments.network_type + ".log")
